package com.runners.choi.runners.play;
...
public class EasyPlayActivity extends AppCompatActivity
    ...
    private TimerTask timerTaskEasy;
    ...
    private int music;
    private int mp2_key = 0;
    /***REPEAT***/
    private MediaPlayer repeatMp;
    //*****END
    ...
    private static final String TAG = "TAG.P";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "music = " + String.valueOf(music));
        ...
        ppDialog = new PrettyDialog(this);
        ...
        stop_play_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (delay_seconds < 1){
                    ...
                    timerTaskEasy.cancel();
                final Toast toast = Toast.makeText(getApplicationContext(), "GAME OVER!", Toast.LENGTH_LONG);
                toast.show();

                bonusTimeAmount = speedBonus + errorBonus;

                Intent i = new Intent(EasyPlayActivity.this, ResultActivity.class);

                //NERF
                if (speedMax > 347358959) {
                    i.putExtra("salt", "A");
                } else if (errorBonus > 199) {
                    i.putExtra("salt", "B");
                } else if (secondRemaining > 99) {
                    i.putExtra("salt", "C");
                } else if (relativeDistance > 95) {
                    i.putExtra("salt", "D");
                } else if (speedBonus > 50) {
                    i.putExtra("salt", "E");
                } else {
                    i.putExtra("salt", "none");
                }
    ...
    public void onLocationChanged(Location location) {
        ...
        if(repeat_count != 0) {
            ...
            relativeDistance = (int) location.distanceTo(standardLocation);
    ...
    public void setDefaultLocation() {
        ...
        if(!isInternetAvailable()) {
            ppDialog.setTitle("오프라인 상태")
                    .setMessage("게임 진행이 원활하지 않을 수 있습니다. WIFI 혹은 데이터 환경을 권장합니다")
                    .addButton("확인",
                            R.color.colorAccent,
        ...
        if(isFirstDialog == 0) {
            ...
            pDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialogInterface) {
                    finish();
                    startActivity(new Intent(EasyPlayActivity.this, MainActivity.class));
                }
            });
    ...
    private void showDialogForPermissionSetting(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EasyPlayActivity.this);
        builder.setTitle("알림");
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        builder.setMessage("러너를 사용하기 위해서는 위치 정보 옵션을 사용해야 합니다.");
        builder.setCancelable(true);
        ...
        if(music != 0){
            ...
            if(mp == null) {
                ...
                if(music == 1){
                    ...
                    mp2 = MediaPlayer.create(this, R.raw.indicator_2);
                    mp.setLooping(true);
                }
    ...
    private void repeatPlay(){
        ...
        if(repeatMp == null){
            repeatMp = MediaPlayer.create(this, R.raw.repeat);
        }
        repeatMp.start();
