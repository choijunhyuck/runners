...
public class HardPlayActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop_play_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(HardPlayActivity.this, ResultActivity.class);
        ...
        if(isFirstDialog == 0) {
            ...
            pDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialogInterface) {
                    finish();
                    startActivity(new Intent(HardPlayActivity.this, MainActivity.class));
                }
            });
    ...
    private void showDialogForPermissionSetting(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HardPlayActivity.this);
        builder.setTitle("알림");
